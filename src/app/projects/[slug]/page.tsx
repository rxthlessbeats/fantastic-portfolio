...
import { baseURL, about, home, person, projects } from "@/resources";
...
export default async function ProjectPost({
  ...
  const post = getPosts(["src", "app", "projects", "posts"]).find(
        ...
        <Column as="section" maxWidth="m" horizontal="center" gap="l" paddingTop="24">
          ...
          <Column maxWidth="s" gap="16" horizontal="center" align="center">
            <SmartLink href={projects.path}>
              <Text variant="label-strong-m">{projects.label}</Text>
            </SmartLink>
          ...
          <Column fillWidth gap="40" horizontal="center" marginTop="40">
            <Line maxWidth="40" />
            <Text as="h2" id="recent-projects" variant="heading-strong-xl" marginBottom="24">
              Recent projects
            </Text>
            <Posts
              exclude={[post.slug]}
